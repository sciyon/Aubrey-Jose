      ...
      <div className="flex lg:flex-row flex-col p-4 w-full">
        <div className="lg:w-1/2 flex">
          <Image 
            ...
            width={577}
            height={433}
            className='rounded-3xl w-fit p-5 lg:ml-40'
          />
        </div>
        <div className="flex flex-col items-center justify-center lg:w-1/2">
          ...
          <h3 className='text-2xl font-crimson'>1:00 pm</h3>
          ...
          <div className="default-text flex flex-col items-center lg:w-1/3 w-5/6 text-center">
            ...
            <p className='pt-3 text-base lg:text-lg'>Assembly time is 12:30pm to ensure you are comfortably seated before the ceremony begins promptly at 1 pm.</p>
